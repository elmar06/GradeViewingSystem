...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="assetsfontawesome/css/all.css">
</head>
<body>
<div class="row">
                ...
                <!--USERNAME-->
                  <div class="row">
                    <div class="col-md-7">
                      <div class="form-group">
                        ...
                        <input type="text" id="username" class="form-control" placeholder="User Name" required>
                          ...
                          <input type="text" name="action" id="action" class="form-control" value="1" hidden>
                       </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        <a href="index.php" style="float: right"><i class="fa fa-user"></i> LogIn as Student</a>
                      </div>
                    </div>
            </form>
          </div>
